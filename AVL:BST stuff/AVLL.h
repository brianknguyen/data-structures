...
class AVL {
 public:
    ...
    void rightRotate (std::shared_ptr<AVLNode> a);
    void leftRotate (std::shared_ptr<AVLNode> a);

    void leftrightRotate(std::shared_ptr<AVLNode> a);
    void rightleftRotate(std::shared_ptr<AVLNode> a) ;
